...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    <meta charset="utf-8">
    <title>Love Storye - Checkout Step 4</title>
                    	...
                    	<div class="span10 offset1">
							...
							<table class="table table-items">
							    ...
							    <tbody>
							        ...
							        <tr>
							        	<td class="image"><img src="images/galeri-7.jpg" alt="" width="124" height="124" /></td>
							        ...
							        <tr>
							        	<td class="image"><img src="images/galeri-8.jpg" alt="" width="124" height="124" /></td>
							        	<td class="desc">Adidas Converse Lorem Ipsum Dolor sit</td>
							        	<td class="qty">
							        	    3					            	    </td>
							        	<td class="price">
							        ...
							        <tr>
							        	<td class="image"><img src="images/fairy4.jpg" alt="" width="124" height="124" /></td>
							        	<td class="desc">Adidas Converse Lorem Ipsum Dolor sit</td>
							        	<td class="qty">
							        	    2					            	    </td>
							        	<td class="price">
							        ...
							        <tr>
							        	<td class="image"><img src="images/gold.jpg" alt="" width="124" height="124" /></td>
							        	<td class="desc">Adidas Converse Lorem Ipsum Dolor sit</td>
							        	<td class="qty">
							        	    1					            	    </td>
							        	<td class="price">
							        ...
							        <tr>
							        	<td class="image"><img src="images/bronze.jpg" alt="" width="124" height="124" /></td>
							        	<td class="desc">Adidas Converse Lorem Ipsum Dolor sit</td>
							        	<td class="qty">
							        	    4					            	    </td>
							        	<td class="price">
							        ...
							        <tr>
							        	...
							        	<td class="stronger"><div class="size-16 align-right">Rp. 27.500.000</div></td>
							        </tr>
							    </tbody>
							</table>
							
							<p class="right-align">
							    <a href="{{ route('home') }}" class="btn btn-warning higher bold">CONFIRM &amp; PAY</a>
							</p>
                    	</div>
                    </div>
                </div>
